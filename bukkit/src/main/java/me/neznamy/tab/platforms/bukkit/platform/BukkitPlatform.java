    ...
    public void registerPlaceholders() {
        ...
        if (Bukkit.getPluginManager().isPluginEnabled("Vault")) {
            ...
            if (rspChat != null) {
                ...
                manager.registerPlayerPlaceholder("%vault-prefix%", 1000, p -> LegacyComponentSerializer.builder().hexColors().useUnusualXRepeatedCharacterHexFormat().build().serialize(MiniMessage.miniMessage().deserialize(chat.getPlayerPrefix((Player) p.getPlayer()))));
